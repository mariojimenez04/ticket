        ...
        <form action="{{ route('authenticate') }}" method="POST">
            ...
            <div class="bg-white w-96 p-6 rounded shadow-2xl">
                ...
                <div class="mb-4">
                    ...
                    <input name="email" id="email" type="email" class="w-full py-2 bg-gray-200 text-gray-700 px-1 outline-none">
                ...
                <div class="mb-4">
                    ...
                    <input name="password" type="password" class="w-full py-2 bg-gray-200 text-gray-700 px-1 outline-none">

                    @error('password')
                        <p class=" text-red-700 px-4 py-3 rounded relative">{{ $message }}*</p>
                    @enderror
                </div>
                <button type="submit" class="bg-sky-500 text-white w-full rounded">Iniciar Sesion</button>
            </div>
        </form>
    </main>
